...
<html lang="zh-CN">
  ...
  <body>
  	...
  	<div class="container">
  		<br>
  		<div class="row mymes">
  		购买旧书　<a class="updatemes" id="addbook2">发布旧书</a>　<a class="updatemes" id="mybooks2">我的书库</a>
		...
		<div style="margin:0 auto; height:500px; width:1025px; font-size:18px;background-image: url('<%=request.getContextPath()%>/plugins/image/jian.png');">
			...
			<table class="table table-condensed">
				...
				<tbody>
					<s:iterator value="#request.allbooks" status="sta1" >
						<!-- allbooks 存储在了Root区域 -->
							<tr>
								<td><s:property value="#sta1.count" /></td>
								...
								<td><a href="/OldBook/otherusermes?oname=<s:property value="username" />"><s:property value="username" /></a></td>
								<td><a onclick="addorder(<s:property value="id" />)"><i class="glyphicon glyphicon-shopping-cart"></i></a></td>
							</tr>
					</s:iterator>
				</tbody>
			</table>
...
<script type="text/javascript">
	function addorder(bid){
		var mymessage=confirm("确认要购买这本书吗？");
		 if(mymessage==true){
		 	window.location.href = "/OldBook/addorder?bid="+bid;
		 }else{
