...
<html lang="zh-CN">
  ...
  <body>
  	...
  	<div class="container">
  		<br>
  		<div class="row mymes">
  		<s:property value="#request.ou.username" />的个人主页
		...
		<div style="margin:0 auto;width:1025px; font-size:18px; height:250px;background-image: url('<%=request.getContextPath()%>/plugins/image/user.png');">
			...
			<tbody>
				...
				<tr>
					<td>　<s:property value="#request.ou.username" />的email</td>
					<td><s:property value="#request.ou.email" /></td>
				</tr>
				<tr>
					<td>　<s:property value="#request.ou.username" />的个人介绍</td>
					<td><s:property value="#request.ou.content" /></td>
				</tr>
			</tbody>
		</table>
		</div>
