...
<html lang="zh-CN">
  ...
  <body>
  	...
  	<div class="container">
  		<br>
  		<div class="row mymes">
  		<a class="updatemes" id="mymes2">我的信息</a>　<a class="updatemes" id="updatemymes">修改信息</a>　修改密码
  		...
  		<div style="margin:0 auto;width:1025px; font-size:18px; height:250px;background-image: url('<%=request.getContextPath()%>/plugins/image/user.png');">
  			<form method="post" action="updatepswsuccess">
  				<br>
			...
			<div class="form-group">
				<label for="email" class="col-sm-2 control-label">请输入新密码</label>
				<div class="col-sm-8">
			...
			<div class="form-group">
				<label for="content" class="col-sm-2 control-label">请确认新密码</label>
				<div class="col-sm-8">
