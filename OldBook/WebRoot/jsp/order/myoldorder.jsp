...
<html lang="zh-CN">
  ...
  <body>
  	...
  	<div class="container">
  		<br>
  		<div class="row mymes">
  		历史订单 —— 我买的书　<a class="updatemes" id="myoldsale">我卖的书</a>
		...
		<div style="margin:0 auto;color:white;height:500px; width:1025px; font-size:18px;background-image: url('<%=request.getContextPath()%>/plugins/image/xixi.png');">
			...
			<table class="table table-condensed">
				...
				<tbody>
					<s:iterator value="#request.myoldbuy" status="sta" >
						<!-- mybooks 存储在了Root区域 -->
							<tr>
...
<script type="text/javascript">
	$("#myoldsale").click(function() {
		window.location.href = "/OldBook/myoldsale";
	});
</script>
<script type="text/javascript">
