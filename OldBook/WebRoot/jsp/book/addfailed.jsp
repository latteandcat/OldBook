...
<html lang="zh-CN">
  ...
  <body>
  	<div class="head">
  		...
  		<div class="col-sm-4 "><a id="index" href=""><span class="glyphicon glyphicon-book yellow"></span>旧书館</a> --- 用旧书交換時光</div>
  		<div class="col-sm-8 ">
  	...
  	<div class="container">
  		<br>
  		<div class="row mymes">
  		<a class="updatemes" id="buybook">购买旧书</a>　发布旧书　<a class="updatemes" id="mybooks2">我的书库</a>
		...
		<div style="margin:0 auto;height:500px; width:1025px; font-size:18px;background-image: url('<%=request.getContextPath()%>/plugins/image/jian.png');">
			<form method="post" action="addbooksuccess">
			<br>
			<div class="form-group">
				<label for="bookname" class="col-sm-2 control-label">书名</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="b.bookname" name="b.bookname"
						placeholder="请输入书名">
				</div>
			</div><br><br>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="b.author" name="b.author"
						placeholder="请输入作者">
				</div>
			</div><br><br>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="b.damage" name="b.damage"
						placeholder="请输入破损度">
				</div>
			</div><br><br>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="b.price" name="b.price"
						placeholder="请输入价格">
				</div>
			</div><br><br>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control" rows="3" id="b.content " name="b.content"></textarea>
				</div>
			</div><br>
			<div class="form-group">
